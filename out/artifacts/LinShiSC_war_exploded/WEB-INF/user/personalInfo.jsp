...
<div class="container">
    <div style="width: 100%;float: left;">
		    <div style="width: 20%;height:500px;float: left;background-image:url(${pageContext.request.contextPath}/image/userBG.jpg);background-repeat:no-repeat;background-position:0% 0%;background-size:cover;">
						 ...
						 <td valign="top" align="middle">
							 <table cellSpacing=0 cellPadding=0 width=150 border=0>
							  ...
							  <table id=child1 style="DISPLaY: block;" cellSpacing=0 cellPadding=0 width=150 border=0>
								 <tr height=20>
									  <td>
									  	<a style="cursor: pointer;font-size: 15px;color: red;margin-left: 35px;margin-top: 15px;display: block;width: 120px;height: 40px;line-height: 40px; background-color: #00ee00;" href="${pageContext.request.contextPath}/user/userInfo" target="right">个人中心</a>
									  </td>
								  </tr>
								  <tr height=20>
									  <td>
									 	 <a style="cursor: pointer;font-size: 15px;color: red;margin-left: 35px;margin-top: 15px;display: block;width: 120px;height: 40px;line-height: 40px;background-color: #00ee00;" class="menuChild" href="${pageContext.request.contextPath}/user/userGoOrder" target="right">我的订单</a>
									  </td>
								  </tr>
								  <tr height=20>
									  <td>
									  	<a style="cursor: pointer;font-size: 15px;color: red;margin-left: 35px;margin-top: 15px;display: block;width: 120px;height: 40px;line-height: 40px;background-color: #00ee00;" class="menuChild" href="${pageContext.request.contextPath}/user/userGoSuccessOrder" target="right">历史订单</a>
									  </td>
								  </tr>
							  </table>
							 <%-- <table cellSpacing=0 cellPadding=0 width=150 border=0>
...
<div class="container footer">
	<div class="span24">
		<div class="copyright">筱筱 著作网上商城 版权所有</div>
	</div>
</div>
